...
image = Image.open('Data/diabete.jpg')
st.image(image, use_column_width=True)
patients = st.selectbox("Number of patients",(540,544,552,559,563,567,'Union'))
...
patients_sidebar = st.sidebar.selectbox("Number of patients sidebar",(540,544,552,559,563,567,'Union'))
for i in range(8):
...
if (st.button('Predict')):
    string_model = 'Data/model/model' + str(patients) + '.h5'
...
if button_side:
    ...
    string_model = 'Data/model/model' + str(patients_sidebar) + '.h5'
    model = load_model(string_model)
